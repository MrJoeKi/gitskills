...
public class Canny extends Component {
    ...
    public static void main(String[] args) throws IOException{
        ...
        String imageName = "D:\\JaveDev\\Graduation\\imagehandled\\gray\\ (2)_gray.bmp";
        String desImageName = "D:\\JaveDev\\Graduation\\imagehandled\\Canny200.bmp";
        BufferedImage sourceImage = ImageIO.read(new File(imageName));
        edgeDetector.setSourceImage(sourceImage);
        edgeDetector.setThreshold(200);
        ...
        File newfile = new File(desImageName);
        BufferedImage bi = new BufferedImage(150, 60, BufferedImage.TYPE_BYTE_BINARY);
